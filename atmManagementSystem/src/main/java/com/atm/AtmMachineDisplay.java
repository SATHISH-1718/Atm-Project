...
import com.atm.AtmManagementSystem.UserIdentification;
		...
		try {
				...
				switch (option) {
					...
					case 5:
						...
						int receiverNumber = Integer.parseInt(reader.readLine());
						Card card1 = db.getCardWithAccountNumber(receiverNumber);
